...
export const projectsData = [
    ...
    },
    {
        id: 3,
        name: 'ERP',
        description: 'Me and my team build an ERP system. Mainly focused on helping and making easier for Bussiness. ERP contain all the nesscarry modules for managing business. It has role base authority. I have attendance management,Empolyee management, Payroll, Messaging System',
        tools: ['PHP', 'Bootstrap', 'SCSS', 'APIs', 'HTML', 'TypeScript', 'Mysql', 'Open AI', 'Google APIs', 'Slack Api', 'Socket.io', 'AI'],
        code: '',
        role: 'Full Stack Developer',
        demo: '',
        image: '',
